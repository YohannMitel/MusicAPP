      ...
      <div class="row justify-content-center align-items-center text-center">
        <div class="col-md-8">
          <div class="gif-container">
            ...
            : '/gif/muchachos-statico-f1.png' : '/gif/muchachos.gif'" 
              alt="muchachachos"
              class="centered-gif" />
          </div>
...
onMounted(() => {
  emits('initHeader', { pageTitle: 'Chachachas | SessionID : '+props.sessionId, breadcrumbs: [{ label: 'Home', url: '/' }, { label: 'Chachachas', url: '' }] });
...
const start = () => {
  ...
  audio.volume = 0.01 // Ajuster le volume si nécessaire
